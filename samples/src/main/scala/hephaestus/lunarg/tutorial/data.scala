...
object Cube {
  ...
  private def XYZ1(x: Int, y: Int, z: Int): Vec4 = Vec4(x.toFloat, y.toFloat, z.toFloat, 1f)
  ...
  val solidFaceColorsData: ByteBuffer = Buffer.direct(solidFaceColors.flatMap(_.list):_*).value
