...
object Step13 extends Utils {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val imageAcquiredSemaphoreCreateInfo =
      new Vulkan.SemaphoreCreateInfo(flags = 0)
    val imageAcquiredSemaphore =
      vk.createSemaphore(device, imageAcquiredSemaphoreCreateInfo)
